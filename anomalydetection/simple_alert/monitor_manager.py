import os
import importlib
from .models import MeasurementCollection
...
class MonitorManager:
    def __init__(self):
        ...
        plugins = os.listdir('simple_alert/detection_methods')
        plugin_list = []
        ...
        self._plugins = [
            importlib.import_module(f'simple_alert.detection_methods.{plugin}').DetectionMethod() for plugin in plugin_list
        ]
